...
const _avatarPresetsData: AvatarPreset[] = [
  // ===== BLOB PRESETS =====
  {
    ...
    blob: {
      ...
      time: { x: 12, y: 9, z: 14 },
      rotation: { x: 0.004, y: 0.006, z: 0.003 },
      scale: 3.2,
      opacity: 1,
      shininess: 80,
      lightIntensity: 1.3,
  ...
  },
  {
    ...
    blob: {
      ...
      spikes: { x: 1.5, y: 2.2, z: 1.8 },
      amplitude: { x: 1.0, y: 1.8, z: 1.2 },
      time: { x: 7, y: 5, z: 9 },
      rotation: { x: 0.002, y: 0.004, z: 0.003 },
      scale: 3.2,
      opacity: 0.75,
      shininess: 100,
      lightIntensity: 1.5,
  ...
  },
  {
    ...
    blob: {
      ...
      spikes: { x: 8, y: 0.35, z: 0.2 },
      amplitude: { x: 0.6, y: 0.7, z: 0.5 },
      time: { x: 3, y: 5, z: 4 },
  ...
  },
  {
    ...
    blob: {
      ...
      amplitude: { x: 0.4, y: 0.6, z: 0.5 },
      time: { x: 12, y: 15, z: 10 },
      rotation: { x: 0.002, y: 0.001, z: 0.002 },
      scale: 3.2,
      opacity: 0.65,
      shininess: 180,
      lightIntensity: 1.7,
  ...
  },
  {
    ...
    blob: {
      ...
      spikes: { x: 1.0, y: 1.5, z: 0.8 },
      amplitude: { x: 1.4, y: 0.9, z: 1.2 },
      time: { x: 13, y: 5, z: 10 },
